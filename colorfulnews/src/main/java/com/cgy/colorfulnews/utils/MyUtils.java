...
public class MyUtils {
    ...
    public static boolean isNightMode() {
        SharedPreferences preferences = App.getAppContext().getSharedPreferences(Constants.SHARES_COLOURFUL_NEWS, Activity.MODE_PRIVATE);
    ...
    public static SharedPreferences getSharedPreferences() {
        return App.getAppContext().getSharedPreferences(Constants.SHARES_COLOURFUL_NEWS, Context.MODE_PRIVATE);
    }
    ...
    private static int calculateTabWidth(TabLayout tabLayout) {
        ...
        for (int i = 0; i < tabLayout.getChildCount(); i++) {
            ...
            view.measure(0, 0);//通知父view测量, 以便能够保证获取到宽高
